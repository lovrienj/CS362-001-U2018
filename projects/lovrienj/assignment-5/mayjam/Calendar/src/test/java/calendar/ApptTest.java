...
public void ApptCreationAndStartTime()  throws Throwable  {
    ...
    assertEquals(15, startTimeSet.getStartDay());
    ...
    assertEquals(23, startNoTime.getStartDay());
...
@Test(timeout = 4000)
 public void ValidTimes()  throws Throwable  {
    ...
    /**Testing For Days */
    /******* */
    Appt badDayLow = new Appt(12, 30, -1, 9, 2018, "Birthday", "It's my big birthday bash!", "wazzah@gmail.com");
    badDayLow.setValid();
    Appt badDayHigh = new Appt(12, 40, 35, 9, 2018, "Birthday", "It's my big birthday bash!", "wazzah@gmail.com");
    badDayHigh.setValid();
    //high31 is to check that the months is working because some days do have 31 days
    Appt badDayHigh31 = new Appt(11, 30, 31, 9, 2018, "Birthday", "It's my big birthday bash!", "wazzah@gmail.com");
    badDayHigh31.setValid();
    
    assertFalse(badDayLow.getValid());
